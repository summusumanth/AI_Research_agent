...
app = FastAPI(
    title="arXiv Curator API",
    description="arXiv CS.AI paper curator with agentic RAG capabilities",
...
# Serve the web chat UI (HTML/CSS/JS) from the static directory.
# The UI lives at frontend/ and is mounted at the site root.
